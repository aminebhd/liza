require "./object.rb"
# Represents a Liza class in the Ruby world. Classes are objects in Liza so they
# inherit from LizaObject.
class Liza < LizaObject
  ...
  # Create an instance of this Liza class that holds a Ruby value. Like a String, 
  # Number or true.
  def new_with_value(value)
    LizaObject.new(self, value)
  end
end